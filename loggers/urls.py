...
from warehouse.views import LogisticsViewSet, OrderToLogisticsViewSet, OrderViewSet, MenuViewSet, FoodListViewSet, OrderToFoodListViewSet
...
router.register(r'logsprep', OrderToLogisticsViewSet)
